        ...
        <div className="pop" id="popup" key={ind}>
          ...
          <div className="d-flex pdiv">
            ...
            <div className="pdetail ms-5">
              ...
              <p className="font-d w-4">{detail.name}</p>
            </div>
          </div>
          ...
          <div className="dc d-flex navbar">
            <div className="end">
              ...
              <div className="d-flex">
                <div className="dn">
                  <input className="datebar" id="myid" type="date" placeholder={detail['expiry_date']} />
                  <p className="note">
                    Note : Changes made will be reflected after 48 hours
                  </p>
                </div>
                <button className="sav" onClick={myfunction}>
                  Save
                  {/* {detail?detail['expiry_date']:''} */}
                </button>
              </div>
            </div>
            <div className="commision">
              ...
              <div className="d-flex">
                <div className="dn">
                  <input className="datebar p-1" placeholder={detail.commission} type="number" />
                  <p className="note">
                    Note : Changes made will be reflected after 48 hours
                  </p>
                </div>
